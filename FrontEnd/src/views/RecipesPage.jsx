...
export default function RecipesPage() {
    ...
    useEffect(() => { setPage(1); refetch() }, [search, ordering, refetch])
    useEffect(() => { setParams(p => { selectedCat ? p.set('category', selectedCat) : p.delete('category'); return p }) }, [selectedCat, setParams])
